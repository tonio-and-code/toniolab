...
export default function WordReviewDatePage() {
    ...
    useEffect(() => {
        if (dateParam) {
            localStorage.setItem('wordreview-visited-' + dateParam, 'true');
        }
    }, [dateParam]);
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (dateParam && grouped[dateParam]) {
                        ...
                        router.replace(`/english/requiem/${dates[dates.length - 1]}`);
                        return;
                    }
                } else {
    ...
    const goToNextDay = () => {
        ...
        router.push(`/english/requiem/${allDates[nextIdx]}?autoplay=true`);
    };
    ...
    const goToPrevDay = () => {
        ...
        router.push(`/english/requiem/${allDates[prevIdx]}`);
    };
